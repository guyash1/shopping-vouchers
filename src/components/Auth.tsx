    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto bg-blue-500 rounded-full flex items-center justify-center mb-4 shadow-md">
            {isSignUp ? (
          ...
          <p className="text-gray-500 mt-1">
            {isSignUp ? 'הרשם כדי להתחיל לנהל את הקניות שלך' : 'התחבר כדי להמשיך לנהל את הקניות שלך'}
          </p>
        </div>
      ...
      <div className="mt-6 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} רשימת הקניות שלי | כל הזכויות שמורות
      </div>
    </div>
  );
} 